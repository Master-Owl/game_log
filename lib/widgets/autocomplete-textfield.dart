...
///
/// autocomplete_textfield v 1.6.4
/// 
/// This code was forked from: https://pub.dartlang.org/packages/autocomplete_textfield#-readme-tab-
/// Original Author: Felix McCuaig
///
...
class SimpleAutoCompleteTextField extends AutoCompleteTextField<String> {
  ...
  State<StatefulWidget> createState() => new AutoCompleteTextFieldState<String>(
      ...
      }, suggestionsAmount, submitOnSuggestionTap, clearOnSubmit, focusNode, [],
