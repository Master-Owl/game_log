...
enum SortBy { alphabetical, most_recent, /*most_played,*/ play_time_shortest, play_time_longest }
String sortByString(SortBy sort) {
  switch (sort) {
    case SortBy.most_recent: return 'Most Recent';
    // case SortBy.most_played: return 'Most Played';
    case SortBy.play_time_shortest: return 'Play Time - Shortest';
    case SortBy.play_time_longest: return 'Play Time - Longest';
